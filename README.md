...
🔍 - 1. Vamos começar com uma pesquisa. 
...
🔍 - 2. Com base na questão acima, repita todo o procedimento, mas adicione e exiba mais dois valores nos argumentos: o nome do pet e a espécie dele. 
...
🔍 - 3. Escreva uma função chamada calcularMeuLanche que:
...
🔍 - 4. Crie 2 funções que calculem propriedades de um círculo. 
